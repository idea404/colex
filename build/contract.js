...
let Contractt = (_dec = NearBindgen({}), _dec2 = call({}), _dec3 = view(), _dec(_class = (_class2 = class Contractt {
  constructor() {
...
}, (_applyDecoratedDescriptor(_class2.prototype, "addObjecttoVector", [_dec2], Object.getOwnPropertyDescriptor(_class2.prototype, "addObjecttoVector"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "getVector", [_dec3], Object.getOwnPropertyDescriptor(_class2.prototype, "getVector"), _class2.prototype)), _class2)) || _class);
function getVector() {
  const _state = Contractt._getState();
  if (!_state && Contractt._requireInit()) {
    throw new Error("Contract must be initialized");
  }
  const _contract = Contractt._create();
  if (_state) {
    Contractt._reconstruct(_contract, _state);
  }
  const _args = Contractt._getArgs();
  const _result = _contract.getVector(_args);
  if (_result !== undefined) if (_result && _result.constructor && _result.constructor.name === "NearPromise") _result.onReturn();else env.value_return(Contractt._serialize(_result, true));
}
function addObjecttoVector() {
  const _state = Contractt._getState();
  if (!_state && Contractt._requireInit()) {
    throw new Error("Contract must be initialized");
  }
  ...
  const _args = Contractt._getArgs();
  const _result = _contract.addObjecttoVector(_args);
  Contractt._saveToStorage(_contract);
  if (_result !== undefined) if (_result && _result.constructor && _result.constructor.name === "NearPromise") _result.onReturn();else env.value_return(Contractt._serialize(_result, true));
}

export { Contractt, addObjecttoVector, getVector };
